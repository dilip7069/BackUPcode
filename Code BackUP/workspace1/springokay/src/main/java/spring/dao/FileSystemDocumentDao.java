...
import spring.service.Document;
import spring.service.DocumentMetadata;
...
//    private static final Logger LOG = Logger.getLogger(FileSystemDocumentDao.class);
     ...
     * 
     * @see spring.dao.IDocumentDao#insert(spring.service.Document)
     */
    @Override
...
//            LOG.error(message, e);
     ...
     * the parameter.
     * 
     * @see spring.dao.IDocumentDao#findByPersonNameDate(java.lang.String, java.util.Date)
     */
    @Override
...
//            LOG.error(message, e);
     ...
     * 
     * @see spring.dao.IDocumentDao#load(java.lang.String)
     */
    @Override
