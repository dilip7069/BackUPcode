...
import spring.dao.IDocumentDao;
...
public class ArchiveService implements IArchiveService, Serializable {
     ...
     * @see spring.service.IArchiveService#save(spring.service.Document)
     */
    @Override
     ...
     * @see spring.service.IArchiveService#findDocuments(java.lang.String, java.util.Date)
     */
    @Override
     ...
     * @see spring.service.IArchiveService#getDocumentFile(java.lang.String)
     */
    @Override
